...
describe("expandHome", () => {
    ...
    it("expands a leading ~/ to the home directory", () => {
        expect(expandHome("~/.doc-memory/index.db", "/home/alice")).toBe("/home/alice/.doc-memory/index.db");
    });
    it("does NOT touch a ~ that is not at the start (regression)", () => {
        expect(expandHome("/data/~backup/index.db", "/home/alice")).toBe("/data/~backup/index.db");
    });
